...
def train(model, train_loader, device, optimizer, epoch):
    ...
    for batch_idx, (input_mb, lbl,a,b,c,d) in enumerate(train_loader):
...
def eval(model, test_loader, device):
    model.eval()
    input_mb, gt_mb, a,d,c,d = next(iter(test_loader)) # .next()
...
def main(args):
    ...
    train_dataset = get_train_dataloader(args)
    test_dataset = get_test_dataloader(args)
    ...
    checkpoints_saved_dir = args.dst_dir + '/torch_checkpoints_saved' # "./torch_checkpoints_saved"
